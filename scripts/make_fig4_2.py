"""make_fig4_2.py — fig4_2: Структура программных модулей проекта.

Рисунок собирается из PlantUML-исходника `scripts/fig4_2.puml`:
PlantUML рендерит PNG (200 DPI), затем ImageMagick оборачивает его в PDF.
Терминология полностью на русском; раскладка ортогональная, без перекрытий.
...
PUML = ROOT / "scripts" / "fig4_2.puml"
PNG = ROOT / "scripts" / "fig4_2.png"
OUT = ROOT / "vkr" / "v2" / "artifacts" / "figures" / "fig4_2.pdf"
...
if __name__ == "__main__":
    ...
    print(f"OK fig4_2 saved: {out} ({size_kb:.1f} KB)")

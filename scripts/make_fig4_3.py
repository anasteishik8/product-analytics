"""make_fig4_3.py — fig4_3: Логика Streamlit-демо как интерфейса к артефактам.

Рисунок собирается из PlantUML-исходника `scripts/fig4_3.puml`:
PlantUML рендерит PNG (200 DPI), затем ImageMagick оборачивает его в PDF.
Слоистая архитектура: пользователь → 4 страницы → lib → замороженные артефакты.
"""
...
PUML = ROOT / "scripts" / "fig4_3.puml"
PNG = ROOT / "scripts" / "fig4_3.png"
OUT = ROOT / "vkr" / "v2" / "artifacts" / "figures" / "fig4_3.pdf"
...
if __name__ == "__main__":
    ...
    print(f"OK fig4_3 saved: {out} ({size_kb:.1f} KB)")
